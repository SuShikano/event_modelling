...
The expected martingale residuals conditioned by the different covariates are close to zero, which implies no need to change the functional form of the model.
